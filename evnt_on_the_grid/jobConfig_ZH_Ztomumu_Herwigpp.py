evgenConfig.description = "POWHEG+Herwig++ Z->mmH production and AU2 CT10 tune"
evgenConfig.keywords = ["ZH" ,"NLO", "Powheg", "herwig", "higgs","muon"]
evgenConfig.inputfilecheck = 'powheg.400002.ZmmH_SM_M125' 
